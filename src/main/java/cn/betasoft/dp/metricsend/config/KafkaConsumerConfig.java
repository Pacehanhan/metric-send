...
import cn.betasoft.dp.metricsend.kafka.MetricValueDeserializer;
...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        // 消费者组
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "group-alarm");
        // Session超时设置
        props.put(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG, "15000");
        // 键的反序列化方式
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        // 值的反序列化方式
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, MetricValueDeserializer.class);
        // offset偏移量规则设置：
